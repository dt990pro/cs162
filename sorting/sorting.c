...
int main(){
	int *nums = NULL, *num1 = NULL, *num2 = NULL, *num3 = NULL;
   int size=0;
   time stop, start;
   ...
   num1 = (int *)malloc(sizeof(int) * 10000000);
   num2 = (int *)malloc(sizeof(int) * 10000000);
   num3 = (int *)malloc(sizeof(int) * 10000000);
   ...
   //insertion
   gettimeofday(&start, NULL);
   insertion_sort(num1, size);
   gettimeofday(&stop, NULL);
   printf("MicroSeconds insertion: %d\n", stop.tv_usec - start.tv_usec);
   printf("Seconds: %d\n", stop.tv_sec - start.tv_sec);
   //print_array(num1, size);*/
   //selection
   gettimeofday(&start, NULL);
   selection_sort(num3, size);
   gettimeofday(&stop, NULL);
   printf("MicroSeconds selection: %d\n", stop.tv_usec - start.tv_usec);
   printf("Seconds: %d\n", stop.tv_sec - start.tv_sec);
   //print_array(num3, size);
   //merge
   /*gettimeofday(&start, NULL);
   merge_sort(num2, 0, size - 1);
   gettimeofday(&stop, NULL);
   printf("MicroSeconds merge: %d\n", stop.tv_usec - start.tv_usec);
   printf("Seconds: %d\n", stop.tv_sec - start.tv_sec);
